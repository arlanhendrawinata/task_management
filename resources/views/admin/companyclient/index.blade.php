        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="d-flex">
                        <div>
                            <a href="/tambahcompanyclient" class="btn btn-primary btn-sm"><i class="fa fa-plus-circle "></i> Add Company Client</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <div class="table-bordered table-responsive" style="padding : 10px;">
                        <table id="example" class="clientTable table table-striped " style="max-width: 95%;">
                            ...
                            <tbody>
                                @foreach($cclients as $number => $item )
                                {{-- href="javascript:void(0);" --}}
                                <tr>
                                    <td>{{ $number+1 }}</td>
                                    <td class="alignLeft">{{ $item->name }} </td>
                                    <td class="alignLeft">{{ $item->description }}</td>
                                    <td class="alignLeft">{{ $item->alamat }}</td>
                                    <td style="width: 10%;">
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center">
                                            ...
                                            <a href="" class="btn  btn-detail btn-success shadow btn-xs sharp mr-1" data-bs-toggle="tooltip" title="Click to see company client details" style="cursor: pointer;" data-bs-toggle="modal" data-attr="{{ route('company-client-detail', $item->id) }}" hidden><i class="fa fa-info"></i></a>
                                            <!-- detail Modal -->
                                            ...
                                            <a href="/editcclient{{ $item->id }}" class="btn btn-primary shadow btn-xs sharp mr-1" title="Click to edit company client"><i class="fa fa-pencil"></i></a>
