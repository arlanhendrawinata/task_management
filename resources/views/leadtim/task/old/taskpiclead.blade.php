            ...
            <table class="table table-striped">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a class="btn btn-danger btn-delete shadow btn-xs sharp px-2" data-bs-toggle="tooltip" title="Remove PIC" data-id="{{$project->id}}" data-link=" {{ route('lead-deletepic', ['id'=>$pic->id]) }}" style="cursor: pointer;"><i class="fa fa-trash" style="color:white"></i></a></td>
                    </tr>
                    @endif
                    @empty
                    <tr>
