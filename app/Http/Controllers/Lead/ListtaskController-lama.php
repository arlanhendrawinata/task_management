...
class ListtaskController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        $title = "Submit Task";
        return view('leadtim/listtask/kumpultask', compact('project', 'companies', 'clients', 'divisions', 'users', 'title'));
    }
    ...
    public function update(Request $request)
    {
        ...
        return redirect()->route('user-list-task')->with('success', 'Task berhasil submit');
    }
    ...
    public function startDate(Request $request)
    {
        ...
        return redirect()->route('user-list-task')->with('success', 'Task dimulai');
    }
    ...
    public function dashboardlist(Request $request)
    {
        ...
        if ($request->input('status') == 3) {
            $listtask = Project::with('companies', 'clients', 'divisions', 'users')
                ...
                ->whereIn("status", [3])
                ->orderBy('id', 'desc');
            $listtask = $listtask->paginate(2)->appends([
                'status' => $request->status
            ]);
